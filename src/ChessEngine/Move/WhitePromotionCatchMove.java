...
//white pawn catch after which pawn will get promoted
public class WhitePromotionCatchMove implements Move, Cloneable, PromotionMove{
	...
	WhitePromotionCatchMove(Game game, int startHor, int startVer, int finalHor, int finalVer, char promotedTo){
		this.game= game;
	...
	public void undoOn() {
		...
		game.swapTiles(startHorCord, startVerCord, finalHorCord, finalVerCord);
		game.setTile(startHorCord, startVerCord, orginalPiece);
	...
	public boolean isLegal(){
		if(finalVerCord != 0)return false;
